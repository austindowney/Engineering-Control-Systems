...
\input{Chapter_1_Basic_Concepts/Chapter_1_Basic_Concepts.tex}

% what remains does not work as it tries to draw from the PDF notes. 

% Chapter 2 systems
\include{Chapter_2_Systems/Chapter_2_Systems.tex}

% Chapter 3 Transfer Functions
\include{Chapter_3_Transfer_Functions/Chapter_3_Transfer_Functions.tex}

% Chapter 4 Time Series Response
\include{Chapter_4_Time_Series_Response/Chapter_4_Time_Series_Response.tex}

% Chapter 5 Performance Indicators
\include{Chapter_5_Performance_Indicators/Chapter_5_Performance_Indicators.tex}

% Chapter 6 System Identification
\include{Chapter_6_System_Identification/Chapter_6_System_Identification.tex}

% Chapter 5 Control systems
\include{Chapter_7_Control_systems/Chapter_7_Control_systems.tex}

% Chapter 6 Frequency Analysis
\include{Chapter_8_Frequency_Analysis/Chapter_8_Frequency_Analysis.tex}

% Chapter 7 Additional Topics
\include{Chapter_9_Additional_Topics/Chapter_9_Additional_Topics.tex}
