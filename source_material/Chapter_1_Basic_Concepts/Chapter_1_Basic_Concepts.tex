...
\noindent \textbf{Process} - The device, plant, or system under control. The input and output relationship represents the cause-and effect relationship of the process.
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.5\textwidth]{../figures/generated/ch01/ch01_cs_io.pdf}
...
\noindent \textbf{Open-Loop Control Systems} - utilize a controller or control actuator to obtain the desired response.
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=\textwidth]{../figures/generated/ch01/ch01_cs_open_loop.pdf}
...
\noindent \textbf{Closed-Loop Control Systems} - utilizes feedback to compare the actual output to the desired output response.
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=\textwidth]{../figures/generated/ch01/ch01_cs_closed_loop.pdf}
...
\noindent \textbf{Multivariable Control System} - a control system with multiple input, control, and output variables. These signals are commonly represented as vectors.


		\begin{figure}[H]
			\centering
			\includegraphics[width=\textwidth]{../figures/generated/ch01/ch01_cs_mimo.pdf}
			\caption{Multivariable feedback control system with vector-valued input, control, and output signals.}
