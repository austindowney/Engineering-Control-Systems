...
\begin{figure}[H]
	\centering
	\includegraphics[]{../figures/controller_PID_temporal_responses.png}
	\caption{Response for a 1-DOF system controlled with a PID controller, showing: (a) system response and the step function input, and (b) the controller response imposed on the system to obtain such responses.}
...
\begin{figure}[H]
	\centering
	\includegraphics[]{../figures/controller_P_temporal_response.png}
	\caption{Response for a 1-DOF system controlled with a just a proportional (P) controller.}
	\label{fig:PID_controller_P_temporal_responses}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[]{../figures/controller_PI_temporal_response.png}
	\caption{Response for a 1-DOF system controlled with a PI controller.}
	\label{fig:PID_controller_PI_temporal_responses}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[]{../figures/controller_PD_temporal_response.png}
	\caption{Response for a 1-DOF system controlled with a PD controller.}
	\label{fig:PID_controller_PD_temporal_responses}
\end{figure}

\begin{review}[Nicolas Minorsky and the Need for Better Control]
