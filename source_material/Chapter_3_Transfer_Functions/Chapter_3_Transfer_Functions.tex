...
\begin{review}[Laplace Transforms]
...
\begin{example}[Double-Impact Response]
...
\begin{example}[Sinusoidally Forced Spring--Mass--Damper System]
	Considering the forced system:
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.4\textwidth]{../figures/1-DOF-spring_dashpot_mass_horizontal_forced.png}
...
\begin{review}[Frequency and Time Domains]
...
\begin{example}[Response PSD under White-Noise Excitation]
	Consider the following system
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.4\textwidth]{../figures/1-DOF-spring_dashpot_mass_horizontal_forced.png}
...
\begin{example}[Mean-Square Response to White Noise]
...
\begin{example}[Partial Fractions with MATLAB]
